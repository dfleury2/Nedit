...
// TODO: static Fl_Color allocBGColor(Fl_Widget* w, char* colorName, int* ok);
// TODO: static Fl_Color getRangesetColor(Ne_Text_Display* textD, int ind, Fl_Color bground);
...
// TODO:    fl_rect(x(), y(), w() - vScrollBar->w(), h() - hScrollBar->h(), FL_RED);

   // Drawing Text Area
// TODO:    fl_rect(left, top, width, height, FL_GREEN);

   // Drawing line number area
// TODO:    fl_rect(lineNumLeft, top, lineNumWidth, height, FL_YELLOW);

   // Drawing Text Area
// TODO:    fl_rect(lineNumLeft, top, this->width + this->left - lineNumLeft, this->height, FL_WHITE);
...
// TODO:    textD->cursorFGGC = XtGetGC(widget, GCForeground, &gcValues);
   textD->lineStarts = (int*)malloc(sizeof(int) * textD->nVisibleLines);
...
void TextDFree(Ne_Text_Display* textD)
{
   ...
   free((char*)textD->lineStarts);
   free((char*)textD->bgClassPixel);
   free((char*)textD->bgClass);
// TODO:    free((char*)textD);
}
...
void TextDResize(Ne_Text_Display* textD, int width, int height)
{
   ...
   {
      free((char*)textD->lineStarts);
      textD->lineStarts = (int*)malloc(sizeof(int) * newVisibleLines);
   }
...
// TODO:       NeStyleTableEntry* styleRec;
...
// TODO:       {
// TODO:          styleRec = &textD->styleTable[(style & STYLE_LOOKUP_MASK) - 'A'];
...
// TODO: // TODO:       gcValues.foreground = gcValues.background = bground;
// TODO: // TODO:       XChangeGC(XtDisplay(textD->w), gc, GCFont | GCForeground | GCBackground, &gcValues);
// TODO:    }
...
// TODO:    int r, g, b;
// TODO:    *ok = 1;
// TODO:    return AllocColor(w, colorName, &r, &g, &b);
// TODO: }
// TODO: 
// TODO: static Fl_Color getRangesetColor(Ne_Text_Display* textD, int ind, Fl_Color bground)
// TODO: {
