...
#define N_ATOMS 11
enum NeAtomIndex {A_TEXT, A_TARGETS, A_MULTIPLE, A_TIMESTAMP,
...
enum NeInsertResultFlags {INSERT_WAITING, UNSUCCESSFUL_INSERT, SUCCESSFUL_INSERT};

/* Actions for selection notify event handler upon receiving confermation
   of a successful convert selection request */
enum NeSelectNotifyActions {UNSELECT_SECONDARY, REMOVE_SECONDARY,
                          EXCHANGE_SECONDARY
                         };
...
// TODO: static void modifiedCB(int pos, int nInserted, int nDeleted, int nRestyled, const char* deletedText, void* cbArg);
// TODO: static void sendSecondary(Widget w, Time time, Atom sel, int action, char* actionText, int actionTextLen);
// TODO: static void getSelectionCB(Widget w, void* clientData, Atom* selType, Atom* type, void* value, unsigned long* length, int* format);
// TODO: static void getInsertSelectionCB(Widget w, void* clientData,Atom* selType, Atom* type, void* value, unsigned long* length, int* format);
// TODO: static void getExchSelCB(Widget w, void* clientData, Atom* selType, Atom* type, void* value, unsigned long* length, int* format);
// TODO: static bool convertSelectionCB(Widget w, Atom* selType, Atom* target, Atom* type, void** value, unsigned long* length, int* format);
// TODO: static void loseSelectionCB(Widget w, Atom* selType);
// TODO: static bool convertSecondaryCB(Widget w, Atom* selType, Atom* target, Atom* type, void** value, unsigned long* length, int* format);
// TODO: static void loseSecondaryCB(Widget w, Atom* selType);
// TODO: static bool convertMotifDestCB(Widget w, Atom* selType, Atom* target, Atom* type, void** value, unsigned long* length, int* format);
// TODO: static void loseMotifDestCB(Widget w, Atom* selType);
// TODO: static void selectNotifyEH(Widget w, void* data, int event, bool* continueDispatch);
// TODO: static void selectNotifyTimerProc(void* clientData, XtIntervalId* id);
...
// TODO:    XtGetSelectionValue(w, XA_PRIMARY, XA_STRING, getSelectionCB, &isColFlag, time);
}
...
*/
void SendSecondarySelection(Ne_Text_Editor* text, double time, int removeAfter)
{
   TRACE();
...
{
   TRACE();
   if (!textD->buffer->secondary.selected)
      return;
...
// TODO:    static bool isColFlag;
// TODO:    static void* clientData[2] =
// TODO:    {(void*)& isColFlag, (void*)& isColFlag};
// TODO: 
...
{
   textD->text.isColumnar = isColumnar;

   Fl::paste(*textD, 1); // FL_PASTE call
}
...
{
   if (textD->text.motifDestOwner || textD->text.readOnly)
      return;

   /* Take ownership of the MOTIF_DESTINATION selection */
// TODO:    if (!XtOwnSelection(w, getAtom(XtDisplay(w), A_MOTIF_DESTINATION), time, convertMotifDestCB, loseMotifDestCB, NULL))
// TODO:    {
// TODO:       return;
// TODO:    }
   textD->text.motifDestOwner = true;
}
...
// TODO:    cbInfo = (selectNotifyInfo*)XtMalloc(sizeof(selectNotifyInfo));
...
// TODO:    XtAddEventHandler(w, 0, true, selectNotifyEH, (void*)cbInfo);
// TODO:    cbInfo->timeoutProcID = XtAppAddTimeOut(context,
// TODO:                                            XtAppGetSelectionTimeout(context),
// TODO:                                            selectNotifyTimerProc, (void*)cbInfo);
// TODO: }
// TODO: 
// TODO: /*
...
// TODO: ** widget.
// TODO: */
// TODO: static void getSelectionCB(Widget w, void* clientData, Atom* selType,
// TODO:                            Atom* type, void* value, unsigned long* length, int* format)
// TODO: {
...
// TODO:    free(string);
// TODO: 
// TODO:    /* The selection requstor is required to free the memory passed
...
// TODO: */
// TODO: static void getInsertSelectionCB(Widget w, void* clientData,Atom* selType,
// TODO:                                  Atom* type, void* value, unsigned long* length, int* format)
// TODO: {
// TODO:    Ne_Text_Buffer* buf = ((TextWidget)w)->text.textD->buffer;
// TODO:    char* string;
...
// TODO: 
// TODO:    /* This callback is required to free the memory passed to it thru value */
// TODO:    free((char*)value);
// TODO: }
// TODO: 
// TODO: /*
...
// TODO: */
// TODO: static void getExchSelCB(Widget w, void* clientData, Atom* selType,
// TODO:                          Atom* type, void* value, unsigned long* length, int* format)
// TODO: {
...
// TODO:       widget's secondary selection with text "value" and free it. */
...
// TODO:       *type = XA_STRING;
// TODO:       *value = (void*)BufGetSelectionText(buf);
...
// TODO:    {
// TODO:       targets = (Atom*)XtMalloc(sizeof(Atom) * N_SELECT_TARGETS);
...
// TODO:    *type = XA_STRING;
// TODO:    *value = (void*)BufGetSecSelectText(buf);
// TODO:    *length = strlen((char*)*value);
// TODO:    *format = 8;
// TODO:    BufUnsubstituteNullChars(*value, buf);
// TODO:    return true;
...
// TODO:    if (*target == getAtom(display, A_TARGETS))
// TODO:    {
// TODO:       targets = (Atom*)XtMalloc(sizeof(Atom) * 3);
...
// TODO: */
// TODO: static void selectNotifyEH(Widget w, void* data, int event,
...
// TODO:       free((char*) cbInfo->actionText);
// TODO:       free((char*)cbInfo);
// TODO:       return;
// TODO:    }
// TODO: 
...
// TODO:    {
// TODO:       string = XtMalloc(cbInfo->length + 1);
...
// TODO:    Ne_Text_Buffer* buf = ((TextWidget)cbInfo->widget)->text.textD->buffer;
// TODO: 
