...
// TODO: static bool setValues(TextWidget current, TextWidget request, TextWidget newWidget);
...
static int spanForward(Ne_Text_Buffer* buf, int startPos, char* searchChars, int ignoreSpace, int* foundPos);
static int spanBackward(Ne_Text_Buffer* buf, int startPos, char* searchChars, int ignoreSpace, int* foundPos);
...
// --------------------------------------------------------------------------
// Install actions for use in translation tables and macro recording, to menu item commands
// --------------------------------------------------------------------------
...
{
// TODO:    printf("Ne_Text_Editor::handle [%d][%s]\n", e, fl_eventnames[e]);
...
// TODO: static void initialize(TextWidget request, TextWidget newWidget)
// TODO: {
// TODO:    XFontStruct* fs = newWidget->text.fontStruct;
// TODO:    char* delimiters;
// TODO:    Ne_Text_Buffer* buf;
// TODO:    Pixel white, black;
// TODO:    int textLeft;
// TODO:    int charWidth = fs->max_bounds.width;
// TODO:    int marginWidth = newWidget->text.marginWidth;
// TODO:    int lineNumCols = newWidget->text.lineNumCols;
// TODO: 
...
// TODO:    white = WhitePixelOfScreen(XtScreen((Fl_Widget*)newWidget));
// TODO:    black = BlackPixelOfScreen(XtScreen((Fl_Widget*)newWidget));
// TODO:    if (newWidget->text.selectBGPixel == white &&
// TODO:          newWidget->core.background_pixel == white &&
// TODO:          newWidget->text.selectFGPixel == black &&
// TODO:          newWidget->primitive.foreground == black)
// TODO:    {
// TODO:       newWidget->text.selectBGPixel = black;
// TODO:       newWidget->text.selectFGPixel = white;
// TODO:    }
// TODO: 
...
// TODO:    textLeft = newWidget->text.marginWidth +
// TODO:               (lineNumCols == 0 ? 0 : marginWidth + charWidth * lineNumCols);
...
// TODO:    delimiters = malloc(strlen(newWidget->text.delimiters) + 4);
// TODO:    sprintf(delimiters, "%s%s", " \t\n", newWidget->text.delimiters);
// TODO:    newWidget->text.delimiters = delimiters;
// TODO: 
...
// TODO:    newWidget->text.textD->cursorOn = false;
// TODO: 
// TODO:    /* Initialize the widget variables */
// TODO:    newWidget->text.autoScrollProcID = 0;
// TODO:    newWidget->text.cursorBlinkProcID = 0;
// TODO:    newWidget->text.dragState = NOT_CLICKED;
// TODO:    newWidget->text.multiClickState = NO_CLICKS;
// TODO:    newWidget->text.lastBtnDown = 0;
// TODO:    newWidget->text.selectionOwner = false;
// TODO:    newWidget->text.motifDestOwner = false;
// TODO:    newWidget->text.emTabsBeforeCursor = 0;
// TODO: 
// TODO: #ifndef NO_XMIM
...
// TODO: #endif
// TODO: 
// TODO:    XtAddEventHandler((Fl_Widget*)newWidget, GraphicsExpose, True,
// TODO:                      (XtEventHandler)redisplayGE, (Opaque)NULL);
// TODO: 
...
// TODO:       XtAddEventHandler((Fl_Widget*)newWidget, NEDIT_HIDE_CURSOR_MASK, false,
...
// TODO: */
// TODO: static bool setValues(TextWidget current, TextWidget request,
// TODO:                          TextWidget newWidget)
// TODO: {
...
// TODO:       TextDSetFont(current->text.textD, newWidget->text.fontStruct);
// TODO:    }
// TODO: 
// TODO:    if (newWidget->text.wrapMargin != current->text.wrapMargin ||
// TODO:          newWidget->text.continuousWrap != current->text.continuousWrap)
// TODO:       TextDSetWrapMode(current->text.textD, newWidget->text.continuousWrap,
// TODO:                        newWidget->text.wrapMargin);
// TODO: 
...
// TODO:    {
// TODO:       char* delimiters = malloc(strlen(newWidget->text.delimiters) + 4);
// TODO:       free(current->text.delimiters);
// TODO:       sprintf(delimiters, "%s%s", " \t\n", newWidget->text.delimiters);
// TODO:       newWidget->text.delimiters = delimiters;
// TODO:    }
// TODO: 
...
// TODO:    {
// TODO:       int marginWidth = newWidget->text.marginWidth;
// TODO:       int charWidth = newWidget->text.fontStruct->max_bounds.width;
// TODO:       int lineNumCols = newWidget->text.lineNumCols;
// TODO:       if (lineNumCols == 0)
// TODO:       {
// TODO:          TextDSetLineNumberArea(newWidget->text.textD, 0, 0, marginWidth);
// TODO:          newWidget->text.columns = (newWidget->core.width - marginWidth*2) / charWidth;
// TODO:       }
// TODO:       else
// TODO:       {
// TODO:          TextDSetLineNumberArea(newWidget->text.textD, marginWidth,
// TODO:                                 charWidth * lineNumCols,
// TODO:                                 2*marginWidth + charWidth * lineNumCols);
// TODO:          newWidget->text.columns = (newWidget->core.width - marginWidth*3 - charWidth
...
// TODO:    {
// TODO:       TextDSetupBGClasses((Fl_Widget*)newWidget, newWidget->text.backlightCharTypes,
// TODO:                           &newWidget->text.textD->bgClassPixel, &newWidget->text.textD->bgClass,
// TODO:                           newWidget->text.textD->bgPixel);
// TODO:       redraw = True;
// TODO:    }
// TODO: 
// TODO:    return redraw;
...
static void processTabAP(Fl_Widget* w, int event, const char** args, int* nArgs)
{
   ...
   outStr = (char*)malloc(toIndent - startIndent + 1);
...
static void deletePreviousWordAP(Fl_Widget* w, int event, const char** args, int* nArgs)
{
   ...
   char* delimiters = textD->text.delimiters;
   bool silent = hasKey("nobell", args, nArgs);
...
static int deleteEmulatedTab(Fl_Widget* w, int event)
{
   ...
   {
      spaceString = (char*)malloc(toIndent - startPosIndent + 1);
...
*/
static int spanForward(Ne_Text_Buffer* buf, int startPos, char* searchChars,
...
*/
static int spanBackward(Ne_Text_Buffer* buf, int startPos, char* searchChars, int
...
// TODO:       XtCallCallbacks((Fl_Widget*)tw, textNsmartIndentCallback, (XtPointer)&smartIndent);
   ...
   indentPtr = indentStr = (char*)malloc(indent + 2);
   *indentPtr++ = '\n';
   if (useTabs)
   {
