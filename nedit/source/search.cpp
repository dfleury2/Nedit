...
void CreateReplaceDlog(Widget parent, WindowInfo* window)
{
   ...
   XtSetArg(args[argcnt], XmNlabelString, st1=MKSTRING(
               "(use up arrow key to recall previous)"));
   argcnt++;
   ...
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString,
            st1=MKSTRING("Regular Expression"));
   argcnt++;
   ...
   XtSetArg(args[argcnt], XmNhighlightThickness, 2);
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString, st1=MKSTRING("Case Sensitive"));
   argcnt++;
   ...
   XtSetArg(args[argcnt], XmNhighlightThickness, 2);
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString, st1=MKSTRING("Whole Word"));
   argcnt++;
   ...
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString,
            st1=MKSTRING("In Multiple Documents"));
   argcnt++;
   ...
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString,
            st1=MKSTRING("Multiple Documents..."));
   argcnt++;
   XtSetArg(args[argcnt], XmNmnemonic, 'M');
   argcnt++;
   XtSetArg(args[argcnt], XmNtopAttachment, XmATTACH_FORM);
   ...
   XtSetArg(args[argcnt], XmNhighlightThickness, 2);
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString, st1=MKSTRING("Replace & Find"));
   argcnt++;
...
void CreateReplaceMultiFileDlog(WindowInfo* window)
{
   ...
   argcnt++;
   XtSetArg(args[argcnt], XmNlabelString,
            st1=MKSTRING("Files in which to Replace All:"));
   argcnt++;
   XtSetArg(args[argcnt], XmNmnemonic, 'F');
   argcnt++;
   label1 = XmCreateLabel(form, "label1", args, argcnt);
