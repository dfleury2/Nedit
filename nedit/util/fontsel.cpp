                 ...
                 Pixel sampleFG, Pixel sampleBG)
{
   ...
   n++;
   XtSetArg(args[n], XmNwidth, 110);
   n++;
   XtSetArg(args[n], XmNheight, 28);
   n++;
   XtSetArg(args[n], XmNshowAsDefault, TRUE);
   n++;
   ...
   n++;
   XtSetArg(args[n], XmNtopWidget, okButton);
   n++;
   XtSetArg(args[n], XmNbottomWidget, okButton);
   n++;
   ...
   n++;
   XtSetArg(args[n], XmNuserData, fontName);
   n++;
   XtSetArg(args[n], XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET);
   n++;
   XtSetArg(args[n], XmNbottomAttachment, XmATTACH_WIDGET);
   n++;
   XtSetArg(args[n], XmNleftWidget, fontName);
   n++;
   XtSetArg(args[n], XmNbottomWidget, fontName);
   n++;
   XtSetArg(args[n], XmNtopOffset, 1);
   n++;
   ...
   XtSetArg(args[n], XmNrightPosition, 99);
   n++;
   XtSetArg(args[n], XmNbottomWidget, nameLabel);
   n++;
   XtSetArg(args[n], XmNleftPosition, 1);
   n++;
   ...
   n++;
   XtSetArg(args[n], XmNforeground, sampleFG);
   n++;
   XtSetArg(args[n], XmNbackground, sampleBG);
   n++;
   ...
   XtSetArg(args[n], XmNbottomAttachment, XmATTACH_WIDGET);
   n++;
   XtSetArg(args[n], XmNleftWidget, dispField);
   n++;
   XtSetArg(args[n], XmNbottomWidget, dispField);
   n++;
   XtSetArg(args[n], XmNtopOffset, 1);
   n++;
   ...
   XtSetArg(args[n], XmNtopOffset, 1);
   n++;
   XtSetArg(args[n], XmNbottomWidget, sampleLabel);
   n++;
   ...
   if (showPropFonts != ONLY_FIXED)
   {
      ...
      XtSetArg(args[n], XmNbottomAttachment,
               XmATTACH_OPPOSITE_WIDGET);
      n++;
      XtSetArg(args[n], XmNrightPosition, 98);
      n++;
      XtSetArg(args[n], XmNtopWidget, sizeToggle);
      n++;
      XtSetArg(args[n], XmNbottomWidget, sizeToggle);
      n++;
      XtSetArg(args[n], XmNtopOffset, 1);
      n++;
   ...
   n = 0;
   XtSetArg(args[n], XmNvisibleItemCount, 15);
   n++;
   ...
   XtSetArg(args[n], XmNbottomWidget, sizeToggle);
   n++;
   XtSetArg(args[n], XmNtopWidget, nameLabel);
   n++;
   XtSetArg(args[n], XmNleftWidget, nameLabel);
   n++;
   XtSetArg(args[n], XmNrightPosition, 52);
   n++;
   ...
   n++;
   XtSetArg(args[n], XmNleftWidget, XtParent(fontList));
   n++;
   XtSetArg(args[n], XmNbottomWidget, XtParent(fontList));
   n++;
   XtSetArg(args[n], XmNrightPosition, 85);
   n++;
   ...
   XtSetArg(args[n], XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET);
   n++;
   XtSetArg(args[n], XmNbottomWidget, XtParent(styleList));
   n++;
   XtSetArg(args[n], XmNleftWidget, XtParent(styleList));
   n++;
   ...
   n++;
   XtSetArg(args[n], XmNuserData, sizeList);
   n++;
   XtSetArg(args[n], XmNbottomAttachment, XmATTACH_WIDGET);
   n++;
   XtSetArg(args[n], XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET);
   n++;
   XtSetArg(args[n], XmNbottomWidget, XtParent(sizeList));
   n++;
   XtSetArg(args[n], XmNleftWidget, XtParent(sizeList));
   n++;
   ...
   n = 0;
   XtSetArg(args[n], XmNcancelButton, cancelButton);
   n++;
                         ...
                         XmFontList* fontList)
{
   ...
   XtSetArg(args[n], XmNeditable, turn_on);
   n++;
   XtSetArg(args[n], XmNcursorPositionVisible, turn_on);
   n++;
   if (turn_on)
   {
      if (!fontList)
      ...
      XtSetArg(args[n], XmNforeground, ctrlBlk->sampleFG);
      n++;
   }
   else
   {
      XtSetArg(args[n], XmNforeground, ctrlBlk->sampleBG);
      n++;
   }
                         ...
                         Boolean* continueToDispatch)
{
   ...
   *continueToDispatch = TRUE;
   ...
   n = 0;
   XtSetArg(args[n], XmNdefaultButton, ctrlBlk->okButton);
   n++;
