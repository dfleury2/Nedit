...
bool BufGetSelectionPos(Ne_Text_Buffer* buf, int* start, int* end, int* isRect, int* rectStart, int* rectEnd);
bool BufGetEmptySelectionPos(Ne_Text_Buffer* buf, int* start, int* end, int* isRect, int* rectStart, int* rectEnd);
