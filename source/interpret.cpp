...
static Inst* ProgP;			 /* next free__ spot for code gen. */
...
static DataValue* StackP;	    /* next free__ spot on stack */
...
static int (*OpFns[N_OPS])() = {returnNoVal, returnVal, pushSymVal, dupStack,
                                ...
                                gt, lt, ge, le, eq, ne, bitAnd, bitOr, and_, or_, not_, power, concat,
...
void InitMacroGlobals()
{
   ...
   XtActionsRec* actions =GetMenuActions(&nActions);
   for (i=0; i<nActions; i++)
   {
      dv.val.xtproc = actions[i].proc;
      InstallSymbol(actions[i].name, ACTION_ROUTINE_SYM, dv);
   }
...
Program* FinishCreatingProgram()
{
   ...
   //newProg = (Program*)malloc__(sizeof(Program));
   //progLen = ((char*)ProgP) - ((char*)Prog);
   //newProg->code = (Inst*)malloc__(progLen);
   newProg = new Program();
   progLen = ((char*)ProgP) - ((char*)Prog);
   newProg->code = new Inst[progLen];
                 ...
                 DataValue* result, RestartData** continuation, char** msg)
{
   ...
   context = (RestartData*)malloc__(sizeof(RestartData));
   context->stack = (DataValue*)malloc__(sizeof(DataValue) * STACK_SIZE);
...
{
   Symbol* s = new Symbol();
   s->name = new char[strlen(name)+1];  /* +1 for '\0' */
   strcpy(s->name, name);
   s->type = type;
   s->value = value;
   if (type == LOCAL_SYM)
...
{
   char* mem = (char*)malloc__(length + sizeof(char*) + 1);
...
static SparseArrayEntry* allocateSparseArrayEntry()
{
   ...
   mem = (SparseArrayEntryWrapper*)malloc__(sizeof(SparseArrayEntryWrapper));
...
// TODO:    /*
// TODO:    ** Call an action routine
// TODO:    */
// TODO:    if (sym->type == ACTION_ROUTINE_SYM)
// TODO:    {
// TODO:       String* argList;
// TODO:       Cardinal numArgs = nArgs;
// TODO:       XKeyEvent key_event;
// TODO:       Display* disp;
// TODO:       Window win;
// TODO: 
// TODO:       /* Create a fake event with a timestamp suitable for actions which need
// TODO:          timestamps, a marker to indicate that the call was from a macro
// TODO:          (to stop shell commands from putting up their own separate banner) */
// TODO:       disp=XtDisplay(InitiatingWindow->mainWindow);
// TODO:       win=XtWindow(InitiatingWindow->mainWindow);
// TODO: 
// TODO:       key_event.type = KeyPress;
// TODO:       key_event.send_event = MACRO_EVENT_MARKER;
// TODO:       key_event.time=XtLastTimestampProcessed(XtDisplay(InitiatingWindow->mainWindow));
// TODO: 
// TODO:       /* The following entries are just filled in to avoid problems
// TODO:          in strange cases, like calling "self_insert()" directly from the
// TODO:          macro menu. In fact the display was sufficient to cure this crash. */
// TODO:       key_event.display=disp;
// TODO:       key_event.window=key_event.root=key_event.subwindow=win;
// TODO: 
// TODO:       argList = (String*)XtCalloc(nArgs, sizeof(*argList));
// TODO:       /* pop arguments off the stack and put them in the argument list */
// TODO:       for (i=nArgs-1; i>=0; i--)
// TODO:       {
// TODO:          POP_STRING(argList[i])
// TODO:       }
// TODO: 
// TODO:       /* Call the action routine and check for preemption */
// TODO:       PreemptRequest = false;
// TODO:       sym->value.val.xtproc(FocusWindow->lastFocus,(XEvent*)&key_event, argList, &numArgs);
// TODO:       free__((char*)argList);
// TODO:       if (PC->func == fetchRetVal)
// TODO:       {
// TODO:          return execError("%s does not return a value", sym->name);
// TODO:       }
// TODO:       return PreemptRequest ? STAT_PREEMPT : STAT_OK;
// TODO:    }
